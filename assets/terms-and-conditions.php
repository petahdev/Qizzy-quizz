...
<head>
    ...
    <title>Gainly - Terms and Conditions</title>
    <style>
        body {
...
<body>
    <div class="container">
        <h1>Gainly - Terms and Conditions</h1>
        <div class="terms-content">
            <h3>Terms and Conditions</h3>
            <p>Welcome to Gainly. By using our platform, you agree to the following terms and conditions:</p>
            ...
            <p><strong>3. Eligibility for Withdrawal:</strong> To be eligible for withdrawal, you must meet the minimum earnings threshold set by Gainly. Currently, the minimum withdrawal is Ksh 20.</p>

            <p><strong>4. Watch Ads for Earnings:</strong> Users earn money by watching advertisements through our platform. By using this service, you agree to comply with all guidelines related to ad watching.</p>

            <p><strong>5. Account Usage:</strong> Each user is allowed only one account. If multiple accounts are detected, they may be permanently suspended.</p>
